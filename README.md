...
Release and versioning rules are documented in [RELEASE_POLICY.md](RELEASE_POLICY.md). The current stable release is `v0.13.0`. The UI package remains private and is not published as an npm library.
